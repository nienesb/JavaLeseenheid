 ...
 */
 /*     a = b; // assignment making a the value of b
        a == b // comparison check if a equals b */
...
public class Main extends Application {
    ...
    public Vak maakVak() {
        ...
        if (nullOrEmpty(cijferStr)) {
            vak = new Vak(naam, ects, studiejaar);
        } else {
    ...
    public Project maakProject() {
        ...
        if (nullOrEmpty(productCijferStr) 
            ...
            // wordt aangeroepen
            project = new Project(naam, ects, studiejaar, productCijfer, procesCijfer, methodenEnTechniekenCijfer);
        }
        lblOutput.setTextFill(Color.BLACK);
